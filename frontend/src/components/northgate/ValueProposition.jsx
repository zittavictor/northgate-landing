...
export default function ValueProposition() {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute inset-0 opacity-[0.55] dotted-divider pointer-events-none"
      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-8 grid lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-6 order-2 lg:order-1">
          <div className="vp-3d relative mx-auto max-w-[560px]">
            ...
            <div className="absolute top-4 left-0 z-20 bg-white shadow-ngcard rounded-2xl border border-black/5 px-3 py-2 ng-float">
              <div className="text-[10px] uppercase tracking-widest text-ng-muted font-bold">
                Latency
              </div>
              <div className="text-base font-extrabold text-ng-text">
                &lt; 800ms
              </div>
            </div>
            <div className="absolute bottom-8 right-0 z-20 bg-white shadow-ngcard rounded-2xl border border-black/5 px-3 py-2 ng-float-slow">
              ...
              <div className="text-base font-extrabold text-ng-green">
                99.99%
              </div>
            </div>
            ...
            <div className="vp-3d-inner relative z-10 flex items-center justify-center">
              <img
                src={HERO_3D}
                alt="NorthGate 3D compliance visual"
                className="w-[78%] h-auto drop-shadow-[0_40px_60px_rgba(43,82,195,0.22)]"
                data-testid="vp-3d-image"
              />
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-6 order-1 lg:order-2">
          ...
          <h2
            className="vp-title mt-4 font-display font-extrabold text-[34px] leading-[1.08] sm:text-[44px] lg:text-[52px] text-black"
            data-testid="vp-headline"
          >
            One compliance layer for{" "}
            <span className="font-serif-accent text-ng-blue">every</span>{" "}
            invoice you issue.
          </h2>

          <div className="vp-text">
            <p className="mt-6 text-[16.5px] text-ng-muted leading-relaxed max-w-xl">
              NorthGate gives finance and operations teams a single, intelligent
              gateway to handle e‑invoicing, validation, and reporting — quietly
              working in the background while you focus on growth.
            </p>
            ...
            <ul className="mt-7 space-y-3.5 max-w-xl">
              {points.map((p, i) => (
                <li
                  ...
                  data-testid={`vp-point-${i}`}
                >
                  <span className="mt-0.5 flex-shrink-0 w-5 h-5 rounded-full bg-ng-blue text-white flex items-center justify-center">
                    <Check size={12} strokeWidth={3} />
                  </span>
                  <span className="text-[15.5px] text-ng-text leading-relaxed">
                    {p}
                  </span>
                </li>
              ))}
            ...
            <a
              href="#features"
              data-testid="vp-cta"
              className="mt-9 inline-flex items-center gap-2 text-ng-blue font-semibold text-[15px] group"
            >
